...
public class SimpleEventListActivityModern extends ListActivity implements OnClickListener{
	...
	public void onClick(View v) {
		switch (v.getId())
		{
			...
			case R.id.searchHomeButton:
				Intent i = new Intent (SimpleEventListActivityModern.this, LaunchpadProjectActivity.class);
				startActivity(i);
				break;
		}
